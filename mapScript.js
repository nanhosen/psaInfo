...
//   var tablehtml = '<table class="table table-hover"><thead>';
...
//     tablehtml += '<tr><th scope="row">' + object.na'</th><td>Mark</td><td>Otto</td><td>@mdo</td></tr>';
...
//         }
  ...
  //   var pointStyle = styles[feature.getGeometry().getType()];;
  ...
  var colorPoint = function(id){
   ...
   var pointStyleFunction = function(feature,resolution){
    ...
    var ercArray = getERCData().then((g)=>(console.log('g',g)))
