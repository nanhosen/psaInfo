...
var getERCData =  async function(){
  let day1 = await ajax({method: 'GET',url: 'https://gbccblm.us/server/day1'}) 
  let day2 = await ajax({method: 'GET',url: 'https://gbccblm.us/server/day2'}) 
  let day3 = await ajax({method: 'GET',url: 'https://gbccblm.us/server/day3'}) 
  var threeDayAray = [day1,day2,day3];
  // console.log('ercDat', day1)
  return threeDayAray
}

function returnDay(g,id){
  var day1 = g[0];
    var day2 = g[1];
    var day3 = g[2];
    var percentileInfo = percentileOb[id];
    var highest = percentileInfo.highest;
    var p50 = percentileInfo.p50;
    var p70 = percentileInfo.p70;
    var p80 = percentileInfo.p80;
    var p90 = percentileInfo.p90;
    var p97 = percentileInfo.p97;
    // console.log('g',day1[id],percentileOb[id])
}

var colorPoint = function(id){
  // let day1 = await ajax({method: 'GET',url: 'https://gbccblm.us/server/day1'}) 
  // console.log('colorPoint', percentileOb[id], day1)
  ...
  // return new ol.style.Fill({color: 'rgba(255, 0, 0, 1)'})
  return new ol.style.Fill({color: newColor})
}

var pointStyleFunction = function(feature,resolution){
// console.log('pointStyleFunction', feature.get('id'))
var id = feature.get('id');
var ercArray = getERCData()
.then(
  (g)=>(returnDay(g,id))
  )
...
pointAr.map((curr)=>{
  ...
  percentileOb[id] = {
    'highest' : curr.properties.highest,
    'p50' : curr.properties.p50,
    'p70' : curr.properties.p70,
    'p80' : curr.properties.p80,
    'p90' : curr.properties.p90,
    'p97' : curr.properties.p97,
  }
})
...
var vectorLayerDemo = new ol.layer.Vector({
